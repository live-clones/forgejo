...
func TestAPIGetTeamReposAccessTokenResources(t *testing.T) {
	// Note: fixture is shared with TestAPIGetTeamRepoAccessTokenResources
...
func TestAPIGetTeamRepoAccessTokenResources(t *testing.T) {
	// Reuses TestAPIGetTeamReposAccessTokenResources fixtures since this test is almost identical, but for fetching a
	// specific repo rather than a list of repos.
	defer unittest.OverrideFixtures("tests/integration/fixtures/TestAPIGetTeamReposAccessTokenResources")()
	defer tests.PrepareTestEnv(t)()
